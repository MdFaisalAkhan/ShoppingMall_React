                ...
                <Card.Body>
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group id="password">
                            ...
                            <Form.Control type="password" ref={passwordRef}  placeholder="Leave this for same"/>
                        </Form.Group>
                        <Form.Group id="password-confirm">
                            <Form.Label>Password Confirmation</Form.Label>
                            <Form.Control type="password" ref={passwordConfirmRef}  placeholder="Leave this for same"/>
                        </Form.Group>
